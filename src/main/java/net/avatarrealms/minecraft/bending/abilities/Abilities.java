...
public enum Abilities {
	...
	Suffocate(BendingSpecializationType.Suffocate, true) {
		...
		@Override
		public String getDescription () {
			return "To use, keep sneaking while watching a player " + "and the target while slowly lose his health."
	...
	WallOfFire(BendingType.Fire, false) {
		...
		public String getDescription () {
			return "To use this ability, click at a location. A wall of fire "
					+ "will appear at this location, igniting enemies caught in it " + "and blocking projectiles.";
		}
	},
	...
	Combustion(BendingSpecializationType.Combustion, true) {
		...
		@Override
		public String getDescription () {
			return "Combustion is a powerful Firebender skill." + " You just need to sneak and aim what you want."
					+ "Then, when the skill will be ready,  the air" + " around the target will explode";
		}
	},
	...
	Torrent(BendingType.Water, true) {
		...
		public String getDescription () {
			return "Torrent is one of the strongest moves in a waterbender's arsenal."
					...
					+ "Instead, if you click you release the water and channel it " + "to flow towards your cursor. "
