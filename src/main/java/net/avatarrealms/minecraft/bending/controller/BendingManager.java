...
import net.avatarrealms.minecraft.bending.model.air.AirPassive;
...
import net.avatarrealms.minecraft.bending.model.water.FastSwimming;
import net.avatarrealms.minecraft.bending.model.water.FreezeMelt;
import net.avatarrealms.minecraft.bending.model.water.HealingWaters;
...
import net.avatarrealms.minecraft.bending.model.water.TorrentBurst;
