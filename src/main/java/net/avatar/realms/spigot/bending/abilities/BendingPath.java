...
public enum BendingPath {
	...
	Mobile		(BendingElement.Air),
	Renegade	(BendingElement.Air),
	
	Balanced	(BendingElement.Water), // Default
	Marksman	(BendingElement.Water),
	Flowless	(BendingElement.Water),
	
	Control		(BendingElement.Fire), // Default
	Nurture		(BendingElement.Fire),
	Lifeless	(BendingElement.Fire),
	
	Patient		(BendingElement.Earth), // Default
	Tough		(BendingElement.Earth),
	Reckless	(BendingElement.Earth),
	
	Equality	(BendingElement.ChiBlocker), // Default
	Seeker		(BendingElement.ChiBlocker),
	Restless	(BendingElement.ChiBlocker);
